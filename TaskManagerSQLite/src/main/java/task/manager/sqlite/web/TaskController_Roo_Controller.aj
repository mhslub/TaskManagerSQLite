...
import task.manager.sqlite.web.TaskController;
...
privileged aspect TaskController_Roo_Controller {
    ...
    void TaskController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("task_deliverydate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
